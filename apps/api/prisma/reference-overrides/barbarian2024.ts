...
const BARBARIAN_LEVEL_REFERENCES = [
  ...
  },
  {
    index: "barbarian-4",
    level: 4,
    features: ["barbarian-ability-score-improvement-1", "barbarian-weapon-mastery-4"],
  },
  {
    index: "barbarian-5",
    level: 5,
...
const BARBARIAN_FEATURE_REFERENCES = [
        ...
        options: [
          ...
          },
          {
            ...
            item: {
              index: "skill-stealth",
              name: "Skill: Stealth",
              url: "/api/2024/proficiencies/skill-stealth",
            },
          },
          {
            option_type: "reference",
  ...
  },
  {
    ...
    desc: [
      ...
      "Path of the Zealot: Warrior of the Gods and Divine Fury channel sacred endurance and wrath into your battle presence.",
    ],
  },
  {
    index: "frenzy",
  ...
  {
    index: "barbarian-weapon-mastery-4",
    level: 4,
  ...
  {
    index: "barbarian-weapon-mastery-10",
    level: 10,
    name: "10: Weapon Mastery",
    desc: [
      "Your training with weapons allows you to use the mastery properties of another kind of Simple or Martial Melee weapons of your choice. Whenever you finish a Long Rest, you can practice weapon drills and change one of your chosen weapon choices.",
    ],
    feature_specific: {
      choose: 1,
      type: "weapon mastery",
...
function createSubclassFeatures(featureIndexes: string[]) {
  return featureIndexes.map((featureIndex) => {
    const feature = BARBARIAN_FEATURE_REFERENCES.find(
      (entry) => entry.index === featureIndex,
    );

    if (!feature) {
      throw new Error(`Missing Barbarian subclass feature reference: ${featureIndex}`);
    }
...
const BARBARIAN_SUBCLASS_REFERENCES = [
  {
    ...
    features: createSubclassFeatures([
      "frenzy",
      "mindless-rage",
      "retaliation",
      "intimidating-presence",
